...
namespace Firebase.iOS.Database
{
...
namespace Firebase.iOS.Database
{
	...
	{
		// -(FIRDatabaseHandle)observeEventType:(id)eventType withBlock:(void (^ _Nonnull)(FIRDataSnapshot * _Nonnull))block;
		[Export("observeEventType:withBlock:")]
		nuint ObserveEventType(NSObject eventType, Action<FIRDataSnapshot> block);

		// -(FIRDatabaseHandle)observeEventType:(id)eventType andPreviousSiblingKeyWithBlock:(void (^ _Nonnull)(FIRDataSnapshot * _Nonnull, NSString * _Nullable))block;
		[Export("observeEventType:andPreviousSiblingKeyWithBlock:")]
		nuint ObserveEventType(NSObject eventType, Action<FIRDataSnapshot, NSString> block);

		// -(FIRDatabaseHandle)observeEventType:(id)eventType withBlock:(void (^ _Nonnull)(FIRDataSnapshot * _Nonnull))block withCancelBlock:(void (^ _Nullable)(NSError * _Nonnull))cancelBlock;
		[Export("observeEventType:withBlock:withCancelBlock:")]
		nuint ObserveEventType(NSObject eventType, Action<FIRDataSnapshot> block, [NullAllowed] Action<NSError> cancelBlock);

		// -(FIRDatabaseHandle)observeEventType:(id)eventType andPreviousSiblingKeyWithBlock:(void (^ _Nonnull)(FIRDataSnapshot * _Nonnull, NSString * _Nullable))block withCancelBlock:(void (^ _Nullable)(NSError * _Nonnull))cancelBlock;
		[Export("observeEventType:andPreviousSiblingKeyWithBlock:withCancelBlock:")]
		nuint ObserveEventType(NSObject eventType, Action<FIRDataSnapshot, NSString> block, [NullAllowed] Action<NSError> cancelBlock);

		// -(void)observeSingleEventOfType:(id)eventType withBlock:(void (^ _Nonnull)(FIRDataSnapshot * _Nonnull))block;
		[Export("observeSingleEventOfType:withBlock:")]
		void ObserveSingleEventOfType(NSObject eventType, Action<FIRDataSnapshot> block);

		// -(void)observeSingleEventOfType:(id)eventType andPreviousSiblingKeyWithBlock:(void (^ _Nonnull)(FIRDataSnapshot * _Nonnull, NSString * _Nullable))block;
		[Export("observeSingleEventOfType:andPreviousSiblingKeyWithBlock:")]
		void ObserveSingleEventOfType(NSObject eventType, Action<FIRDataSnapshot, NSString> block);

		// -(void)observeSingleEventOfType:(id)eventType withBlock:(void (^ _Nonnull)(FIRDataSnapshot * _Nonnull))block withCancelBlock:(void (^ _Nullable)(NSError * _Nonnull))cancelBlock;
		[Export("observeSingleEventOfType:withBlock:withCancelBlock:")]
		void ObserveSingleEventOfType(NSObject eventType, Action<FIRDataSnapshot> block, [NullAllowed] Action<NSError> cancelBlock);

		// -(void)observeSingleEventOfType:(id)eventType andPreviousSiblingKeyWithBlock:(void (^ _Nonnull)(FIRDataSnapshot * _Nonnull, NSString * _Nullable))block withCancelBlock:(void (^ _Nullable)(NSError * _Nonnull))cancelBlock;
		[Export("observeSingleEventOfType:andPreviousSiblingKeyWithBlock:withCancelBlock:")]
		void ObserveSingleEventOfType(NSObject eventType, Action<FIRDataSnapshot, NSString> block, [NullAllowed] Action<NSError> cancelBlock);
