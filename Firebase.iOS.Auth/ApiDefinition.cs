...
namespace Firebase.iOS.Auth
{
	...
	interface FIRUser
	{
		...
		// @property (readonly, nonatomic) NSArray<id> * _Nonnull providerData;
		[Export("providerData")]
		NSObject[] ProviderData { get; }
	...
	partial interface Constants
	{
		...
		unsafe byte* FirebaseAuthVersionString { get; }
	}
}
